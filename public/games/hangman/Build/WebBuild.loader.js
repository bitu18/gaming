            ...
            try {
                return window.WebAssembly
                    ? WebAssembly.validate(
                          new Uint8Array([
                              0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 3, 1, 0, 1, 10, 13, 1, 11,
                              0, 65, 0, 65, 0, 65, 1, 252, 11, 0, 11,
                          ]),
                      )
                        ? WebAssembly.validate(
                              new Uint8Array([
                                  0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 11, 1, 9, 1, 1, 125,
                                  32, 0, 252, 0, 26, 11,
                              ]),
                          )
                            ? WebAssembly.validate(
                                ...
                                ? WebAssembly.validate(
                                    ...
                                    ? !!WebAssembly.validate(
                                          new Uint8Array([
                                              0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 10, 1, 8,
                                              0, 6, 64, 1, 25, 1, 11, 11,
                                          ]),
                                      ) || 'wasm-exceptions'
                                    : 'wasm-simd128'
                                            ...
                                            : ((e = s),
                                              ...
                                              (!n.headers.get('Last-Modified') && !n.headers.get('ETag'))
                                                  ...
                                                  : fetch(s, { method: 'HEAD' }).then(function (t) {
                                                        return (
                                                            (d.revalidated = ['Last-Modified', 'ETag'].every(function (
                                                                e,
                                                            ) {
                                                                return (
                                                                    !n.headers.get(e) ||
